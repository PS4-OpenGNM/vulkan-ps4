 ...
 * real implementations. For now, they return VK_ERROR_FEATURE_NOT_PRESENT or
...
/* === Memory === */
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_AllocateMemory(VkDevice d, const VkMemoryAllocateInfo *i, const VkAllocationCallbacks *a, VkDeviceMemory *m) { (void)d;(void)i;(void)a;(void)m; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_MapMemory(VkDevice d, VkDeviceMemory m, VkDeviceSize o, VkDeviceSize s, VkMemoryMapFlags f, void **p) { (void)d;(void)m;(void)o;(void)s;(void)f;(void)p; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
/* === Buffer === */
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateBuffer(VkDevice d, const VkBufferCreateInfo *i, const VkAllocationCallbacks *a, VkBuffer *b) { (void)d;(void)i;(void)a;(void)b; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_BindBufferMemory(VkDevice d, VkBuffer b, VkDeviceMemory m, VkDeviceSize o) { (void)d;(void)b;(void)m;(void)o; return VK_ERROR_FEATURE_NOT_PRESENT; }

/* === Image === */
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateImage(VkDevice d, const VkImageCreateInfo *i, const VkAllocationCallbacks *a, VkImage *im) { (void)d;(void)i;(void)a;(void)im; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_BindImageMemory(VkDevice d, VkImage im, VkDeviceMemory m, VkDeviceSize o) { (void)d;(void)im;(void)m;(void)o; return VK_ERROR_FEATURE_NOT_PRESENT; }
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateImageView(VkDevice d, const VkImageViewCreateInfo *i, const VkAllocationCallbacks *a, VkImageView *v) { (void)d;(void)i;(void)a;(void)v; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateRenderPass(VkDevice d, const VkRenderPassCreateInfo *i, const VkAllocationCallbacks *a, VkRenderPass *r) { (void)d;(void)i;(void)a;(void)r; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateFramebuffer(VkDevice d, const VkFramebufferCreateInfo *i, const VkAllocationCallbacks *a, VkFramebuffer *f) { (void)d;(void)i;(void)a;(void)f; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateShaderModule(VkDevice d, const VkShaderModuleCreateInfo *i, const VkAllocationCallbacks *a, VkShaderModule *s) {
    if (!d || !i || !s) return VK_ERROR_INITIALIZATION_FAILED;
    /* Stub: store SPIR-V as-is. Real implementation calls libpsbc. */
    VkPs4Device *dev = (VkPs4Device *)d;
    const VkAllocationCallbacks *alloc = a ? a : &dev->allocator;
...
VKAPI_ATTR void VKAPI_CALL vk_ps4_DestroyShaderModule(VkDevice d, VkShaderModule s, const VkAllocationCallbacks *a) {
    if (!d || !s) return;
    VkPs4Device *dev = (VkPs4Device *)d;
    VkPs4ShaderModule *mod = (VkPs4ShaderModule *)s;
    const VkAllocationCallbacks *alloc = a ? a : &dev->allocator;
    if (mod->binary) {
...
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreatePipelineLayout(VkDevice d, const VkPipelineLayoutCreateInfo *i, const VkAllocationCallbacks *a, VkPipelineLayout *p) { (void)d;(void)i;(void)a;(void)p; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateGraphicsPipelines(VkDevice d, VkPipelineCache c, uint32_t n, const VkGraphicsPipelineCreateInfo *i, const VkAllocationCallbacks *a, VkPipeline *p) { (void)d;(void)c;(void)n;(void)i;(void)a;(void)p; return VK_ERROR_FEATURE_NOT_PRESENT; }
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateComputePipelines(VkDevice d, VkPipelineCache c, uint32_t n, const VkComputePipelineCreateInfo *i, const VkAllocationCallbacks *a, VkPipeline *p) { (void)d;(void)c;(void)n;(void)i;(void)a;(void)p; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
/* === Descriptor === */
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateDescriptorSetLayout(VkDevice d, const VkDescriptorSetLayoutCreateInfo *i, const VkAllocationCallbacks *a, VkDescriptorSetLayout *l) { (void)d;(void)i;(void)a;(void)l; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateDescriptorPool(VkDevice d, const VkDescriptorPoolCreateInfo *i, const VkAllocationCallbacks *a, VkDescriptorPool *p) { (void)d;(void)i;(void)a;(void)p; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_AllocateDescriptorSets(VkDevice d, const VkDescriptorSetAllocateInfo *i, VkDescriptorSet *s) { (void)d;(void)i;(void)s; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
/* === Command buffer === */
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateCommandPool(VkDevice d, const VkCommandPoolCreateInfo *i, const VkAllocationCallbacks *a, VkCommandPool *p) { (void)d;(void)i;(void)a;(void)p; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_AllocateCommandBuffers(VkDevice d, const VkCommandBufferAllocateInfo *i, VkCommandBuffer *c) { (void)d;(void)i;(void)c; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
VKAPI_ATTR void VKAPI_CALL vk_ps4_CmdPushConstants(VkCommandBuffer c, VkPipelineLayout l, VkShaderStageFlags s, uint32_t o, uint32_t sz, const void *v) { (void)c;(void)l;(void)s;(void)o;(void)sz;(void)v; }

/* === Sampler === */
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateSampler(VkDevice d, const VkSamplerCreateInfo *i, const VkAllocationCallbacks *a, VkSampler *s) { (void)d;(void)i;(void)a;(void)s; return VK_ERROR_FEATURE_NOT_PRESENT; }
VKAPI_ATTR void VKAPI_CALL vk_ps4_DestroySampler(VkDevice d, VkSampler s, const VkAllocationCallbacks *a) { (void)d;(void)s;(void)a; }

/* === Command pool management === */
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_ResetCommandPool(VkDevice d, VkCommandPool p, VkCommandPoolResetFlags f) { (void)d;(void)p;(void)f; return VK_SUCCESS; }
VKAPI_ATTR void VKAPI_CALL vk_ps4_TrimCommandPool(VkDevice d, VkCommandPool p, VkCommandPoolTrimFlags f) { (void)d;(void)p;(void)f; }

/* === Descriptor pool management === */
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_ResetDescriptorPool(VkDevice d, VkDescriptorPool p, VkDescriptorPoolResetFlags f) { (void)d;(void)p;(void)f; return VK_SUCCESS; }

/* === Image subresource layout === */
VKAPI_ATTR void VKAPI_CALL vk_ps4_GetImageSubresourceLayout(VkDevice d, VkImage i, const VkImageSubresource *s, VkSubresourceLayout *l) { (void)d;(void)i;(void)s; if(l){memset(l,0,sizeof(*l));} }
...
/* === Sync === */
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateFence(VkDevice d, const VkFenceCreateInfo *i, const VkAllocationCallbacks *a, VkFence *f) { (void)d;(void)i;(void)a;(void)f; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateSemaphore(VkDevice d, const VkSemaphoreCreateInfo *i, const VkAllocationCallbacks *a, VkSemaphore *s) { (void)d;(void)i;(void)a;(void)s; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateEvent(VkDevice d, const VkEventCreateInfo *i, const VkAllocationCallbacks *a, VkEvent *e) { (void)d;(void)i;(void)a;(void)e; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
/* === Query === */
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateQueryPool(VkDevice d, const VkQueryPoolCreateInfo *i, const VkAllocationCallbacks *a, VkQueryPool *p) { (void)d;(void)i;(void)a;(void)p; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
/* === Swapchain === */
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_CreateSwapchainKHR(VkDevice d, const VkSwapchainCreateInfoKHR *i, const VkAllocationCallbacks *a, VkSwapchainKHR *s) { (void)d;(void)i;(void)a;(void)s; return VK_ERROR_FEATURE_NOT_PRESENT; }
...
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_GetSwapchainImagesKHR(VkDevice d, VkSwapchainKHR s, uint32_t *c, VkImage *i) { (void)d;(void)s;(void)c;(void)i; return VK_ERROR_FEATURE_NOT_PRESENT; }
VKAPI_ATTR VkResult VKAPI_CALL vk_ps4_AcquireNextImageKHR(VkDevice d, VkSwapchainKHR s, uint64_t t, VkSemaphore sem, VkFence f, uint32_t *i) { (void)d;(void)s;(void)t;(void)sem;(void)f;(void)i; return VK_ERROR_FEATURE_NOT_PRESENT; }

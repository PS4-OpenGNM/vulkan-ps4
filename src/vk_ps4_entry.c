...
static const VkExtensionProperties g_device_extensions[] = {
    ...
    {VK_KHR_CREATE_RENDERPASS_2_EXTENSION_NAME, 1},
    {VK_KHR_DEPTH_STENCIL_RESOLVE_EXTENSION_NAME, 1},
    {VK_KHR_SPIRV_1_4_EXTENSION_NAME, 1},
    {VK_KHR_SHADER_FLOAT_CONTROLS_EXTENSION_NAME, 1},
    {VK_EXT_SCALAR_BLOCK_LAYOUT_EXTENSION_NAME, 1},
    {VK_KHR_UNIFORM_BUFFER_STANDARD_LAYOUT_EXTENSION_NAME, 1},
    {VK_EXT_HOST_QUERY_RESET_EXTENSION_NAME, 1},
    {VK_KHR_SHADER_ATOMIC_INT64_EXTENSION_NAME, 1},
    {VK_KHR_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME, 1},
    {VK_KHR_SHADER_SUBGROUP_EXTENDED_TYPES_EXTENSION_NAME, 1},
    {VK_KHR_VULKAN_MEMORY_MODEL_EXTENSION_NAME, 3},
    {VK_EXT_SEPARATE_STENCIL_USAGE_EXTENSION_NAME, 1},
};
